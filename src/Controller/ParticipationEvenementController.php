...
final class ParticipationEvenementController extends AbstractController
{
    ...
    #[Route('/{id_participation}', name: 'app_participation_evenement_show', methods: ['GET'])]
    ...
    #[Route('/{id_participation}/edit', name: 'app_participation_evenement_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_participation}', name: 'app_participation_evenement_delete', methods: ['POST'])]
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$participationEvenement->getId_participation(), $request->getPayload()->getString('_token'))) {
